...
public class FilteredConfigurationWithRealExtClassesTest extends JGuardTest {
    ...
    public void setUp() {
        ...
        //we build a useful entry for guest authentication
        ...
        //we build a non useful entry for guest authentication
    ...
    public void testGetAppConfigurationEntry() {
        ...
        //an XMLLoginModule and an AuditLoginModule should be present
