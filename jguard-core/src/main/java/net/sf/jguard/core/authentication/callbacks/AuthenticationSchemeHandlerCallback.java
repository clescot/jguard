...
public class AuthenticationSchemeHandlerCallback implements Callback{
    ...
    public String getAuthenticationSchemeHandlerName() {
        return authenticationSchemeHandlerName;
    }

    public void setAuthenticationSchemeHandlerName(String authenticationSchemeHandlerName) {
        this.authenticationSchemeHandlerName = authenticationSchemeHandlerName;
    }
}
