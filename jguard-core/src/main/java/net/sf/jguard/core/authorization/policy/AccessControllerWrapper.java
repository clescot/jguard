...
public interface AccessControllerWrapper {
    ...
    boolean hasPermission(Subject subj, final Permission p);

    void checkPermission(Subject subj, final Permission p) throws AccessControlException, PrivilegedActionException;
