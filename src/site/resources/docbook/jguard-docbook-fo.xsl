...
<!-- 
    ...
    This is the XSL FO (PDF) stylesheet for jGuard documentation.
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="img.src.path">src/site/resources/docbook/</xsl:param>
   ...
   ################################################### -->
    ...
    <xsl:param name="callout.extension">0</xsl:param>
