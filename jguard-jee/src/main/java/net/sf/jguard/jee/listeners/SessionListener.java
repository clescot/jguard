...
public class SessionListener implements HttpSessionListener {
    ...
    static public final Logger logger = LoggerFactory.getLogger(SessionListener.class);
    ...
    public void sessionDestroyed(HttpSessionEvent httpSessionEvent) {
        ...
        if (session != null) {
            try {
                LoginContextWrapperImpl authUtils = (LoginContextWrapperImpl) session.getAttribute(StatefulAuthenticationServicePoint.LOGIN_CONTEXT_WRAPPER);
                if (authUtils != null) {
                    authUtils.logout();
                }
